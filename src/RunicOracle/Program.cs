...
namespace RunicOracle
{
    public class Program
    {
        ...
        {
            //dynamic dll loading
            //interprets runes and rune sets
            //can ask questions like "For this rune set, show me all the properties that appear more than once, that have different values"
