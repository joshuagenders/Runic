...
namespace Runic.Agent.Standalone.Test.IntegrationTests
{
    ...
    public class ApplicationTests
    {
        ...
        [TestMethod]
        public void WhenStepDistributionIsEven_ThenStepExecutionIsEven()
        {
        ...
        [TestCategory("IntegrationTest")]
        [TestMethod]
        public void WhenGraphPatternIsExecuted_ThenThreadLevelsAreSet()
        {
        ...
        [TestCategory("IntegrationTest")]
        [TestMethod]
        public void WhenStepRepeats_ThenStepIsRepeated()
        {
        ...
        [TestCategory("IntegrationTest")]
        [TestMethod]
        public void WhenStringReturn_ThenFlowFollowsReturnStringValues()
        {
        ...
        [TestCategory("IntegrationTest")]
        [TestMethod]
        public void WhenInOrderStepFlowIsExecuted_ThenStepsExecuteAndLoopAround()
        {
